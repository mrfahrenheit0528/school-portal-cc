...
* **Guiller Angelo** - Fixed Azure CLI Windows permission issue by overriding the local configuration directory path

* **Guiller Angelo** - Fixed Bicep validation error: Shortened the Storage Account name prefix to ensure the 24-character maximum length limit was not exceeded

* **Guiller Angelo** - Resolved Azure SQL password complexity policy requirements to allow successful deployment

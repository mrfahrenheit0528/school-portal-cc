...
## **[2026-05-14, 4:00AM] - Infrastructure Deployment & App Integration**

### **Changed**
* **[HERMOSO]** - Overhauled `app.py` to replace mock data with dynamic `pyodbc` connections to Azure SQL and `azure-storage-blob` connections to Azure Storage.

### **Fixed**
* **[HERMOSO]** - Resolved strict tenant security policy block by disabling public blob access 
* **[HERMOSO]** - Resolved routing file downloads securely through the Flask backend (`/download/<filename>`)

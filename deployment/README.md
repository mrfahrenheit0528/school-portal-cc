...
## 🛠️ Step 1: Infrastructure Deployment (Bicep)
...
1. Run the deployment command:
   ```bash
   az webapp up --name csec3portal-webapp-sfajbuykzajcu --resource-group rg-csec3-final
   ```
...
2. Visit the `/health` endpoint to verify database and storage connectivity:
   `http://<your-app-name>.azurewebsites.net/health`
